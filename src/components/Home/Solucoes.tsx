...
export default function Solucoes() {
  ...
  return (
    <section className="container flex flex-col lg:flex-row lg:gap-28 gap-10 items-center justify-center py-28">
      <div className={`${solucao === 1 ? "block" : "hidden"} animeLeft`}>
      ...
      <div className={`${solucao === 2 ? "block" : "hidden"} animeLeft`}>
        <h1 className="lg:text-5xl text-4xl font-bold mb-5 text-balance">
      ...
      <div className={`${solucao === 3 ? "block" : "hidden"} animeLeft`}>
        <h1 className="lg:text-5xl text-4xl font-bold mb-5 text-balance">
      ...
      <div className={`${solucao === 4 ? "block" : "hidden"} animeLeft`}>
        <h1 className="lg:text-5xl text-4xl font-bold mb-5 text-balance">
      ...
      <div className={`${solucao === 5 ? "block" : "hidden"} animeLeft`}>
        <h1 className="lg:text-5xl text-4xl font-bold mb-5 text-balance">
      ...
      <div className={`${solucao === 6 ? "block" : "hidden"} animeLeft`}>
        <h1 className="lg:text-5xl text-4xl font-bold mb-5 text-balance">
      ...
      <div className={`${solucao === 7 ? "block" : "hidden "} animeLeft`}>
        <h1 className="lg:text-5xl text-4xl font-bold mb-5 text-balance">
      ...
      <div className={`${solucao === 8 ? "block" : "hidden"} animeLeft`}>
        <h1 className="lg:text-5xl text-4xl font-bold mb-5 text-balance">
      ...
      <div className={`${solucao === 9 ? "block" : "hidden"} animeLeft`}>
        <h1 className="lg:text-5xl text-4xl font-bold mb-5 text-balance">
      ...
      <div className=" grid grid-cols-[repeat(3,80px)] grid-rows-[repeat(3,80px)] gap-5">
        <button
          ...
          className={`${
            solucao === 1 ? "shadow-[0_0_0_4px_#2D3674] border-none" : ""
          } border flex items-center justify-center rounded-md transition cursor-pointer animate-jump`}
        >
        ...
        <button
          ...
          className={`${
            solucao === 2 ? "shadow-[0_0_0_4px_#2D3674] border-none" : ""
        ...
        <button
          ...
          className={`${
            solucao === 3 ? "shadow-[0_0_0_4px_#2D3674] border-none" : ""
        ...
        <button
          ...
          className={`${
            solucao === 4 ? "shadow-[0_0_0_4px_#2D3674] border-none" : ""
        ...
        <button
          ...
          className={`${
            solucao === 5 ? "shadow-[0_0_0_4px_#2D3674] border-none" : ""
          } border flex items-center justify-center rounded-md transition cursor-pointer`}
        >
        ...
        <button
          ...
          className={`${
            solucao === 6 ? "shadow-[0_0_0_4px_#2D3674] border-none" : ""
        ...
        <button
          ...
          className={`${
            solucao === 7 ? "shadow-[0_0_0_4px_#2D3674] border-none" : ""
          } border flex items-center justify-center rounded-md transition cursor-pointer`}
        >
        ...
        <button
          ...
          className={`${
            solucao === 8 ? "shadow-[0_0_0_4px_#2D3674] border-none" : ""
        ...
        <button
          ...
          className={`${
            solucao === 9 ? "shadow-[0_0_0_4px_#2D3674] border-none" : ""
          } border flex items-center justify-center rounded-md transition cursor-pointer`}
        >
