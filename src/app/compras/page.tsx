...
export default function Planos() {
  ...
  return (
    <>
      ...
      />
      <main className="container animate-slideIn ">
        <div>
      ...
      <section className="container grid lg:grid-cols-2 gap-6 lg:gap-28 lg:items-start justify-center flex-wrap max-md:flex-col-reverse mb-28">
        ...
        <div className="relative">
          <PlanoInfo
            className={`${plano === 0 ? "block" : "hidden"} animate-slideIn`}
            name={planos[0].name}
            description={planos[0].description}
            features={planos[0].features}
          />
          <PlanoInfo
            className={`${plano === 1 ? "block" : "hidden"} animate-slideIn`}
            name={planos[1].name}
            description={planos[1].description}
            features={planos[1].features}
          />
          <PlanoInfo
            className={`${plano === 2 ? "block" : "hidden"} animate-slideIn`}
            name={planos[2].name}
